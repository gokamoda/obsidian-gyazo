 ...
 * https://github.com/gokamoda/obsidian-gyazo
 * 
 * Copyright Go Kamoda
...
var en = {
  ...
  notice: {
    imagePasted: "Successfully saved image to gyazo",
    imageSaving: "Saving image to gyazo",
    imageSavedOnLocal: "Failed to save on gyazo. Saved locally."
  }
};
...
let GyazoPlugin = class extends import_obsidian.Plugin {
  ...
  async handlePaste(evt, editor, view) {
    ...
    let url = await this.gyazo_uploader.uploadImage(buffer, fileName);
    if (url == -1){
      let imagePath = "";
      let imageDir = "";
